...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		xsi:schemaLocation="http://www.zus.pl/bip/pliki/kedu_4.xsd">
			...
			<xsl:if test="report/employer/RCA_id != ''">
			<ZUSRCA status_kontroli="0" status_weryfikacji="P">
				...
				<III status_kontroli="0" status_weryfikacji="P">
					...
					<B>
						...
						<p5><xsl:value-of select="IIIB05"/></p5>
						<p6><xsl:value-of select="IIIB06"/></p6>
			...
			<xsl:if test="report/employer/RSA_id != ''">
			<ZUSRSA status_kontroli="0" status_weryfikacji="P">
				<xsl:attribute name="id_dokumentu">
					<xsl:value-of select="report/employer/RSA_id" />
				</xsl:attribute>
				<I>
					<p1>
						<p1><xsl:value-of select="report/employer/I02_1"/></p1>
				...
				<xsl:for-each select="report/holidays/holiday">
				<III status_kontroli="0" status_weryfikacji="P">
					<xsl:attribute name="id_bloku">
						<xsl:value-of select="id" />
					</xsl:attribute>
					...
					<B>
						...
						<p2><xsl:value-of select="IIIB02"/></p2>
						<p3><xsl:value-of select="IIIB03"/></p3>
						<p4><xsl:value-of select="IIIB04"/></p4>
						<p5><xsl:value-of select="IIIB05"/></p5>
						<p6><xsl:value-of select="IIIB06"/></p6>
					</B>
			...
			<xsl:if test="report/employer/DRA_id != ''">
